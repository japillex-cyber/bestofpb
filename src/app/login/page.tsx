  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex' }}>
      ...
      <div className="auth-photo-panel" style={{ flex: '0 0 45%', position: 'relative', overflow: 'hidden', background: '#04091C' }}>
        <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200&q=80" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.55 }} />
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 48 }}>
          ...
          <p style={{ fontFamily: "'Bricolage Grotesque',sans-serif", fontSize: 22, fontWeight: 400, color: 'rgba(255,255,255,0.8)', lineHeight: 1.5, fontStyle: 'italic', maxWidth: 300 }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', background: '#fff', minHeight: '100vh' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ marginBottom: 28 }}>
            <h1 style={{ fontFamily: "'Bricolage Grotesque',sans-serif", fontSize: 30, fontWeight: 800, color: '#0D1020', letterSpacing: '-0.5px', marginBottom: 8 }}>Welcome back</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 20 }}>
            <button onClick={() => signIn('google', { callbackUrl: '/' })} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, width: '100%', height: 50, background: '#fff', border: '1.5px solid #E4E7EF', borderRadius: 12, fontSize: 14, fontWeight: 600, color: '#2E3448', fontFamily: 'inherit', cursor: 'pointer' }}>
            ...
            <button onClick={() => signIn('facebook', { callbackUrl: '/' })} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, width: '100%', height: 50, background: '#fff', border: '1.5px solid #E4E7EF', borderRadius: 12, fontSize: 14, fontWeight: 600, color: '#2E3448', fontFamily: 'inherit', cursor: 'pointer' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button
              ...
              style={{ width: '100%', height: 52, background: loading ? '#9AA3B8' : '#0057FF', color: '#fff', border: 'none', borderRadius: 12, fontSize: 16, fontWeight: 700, fontFamily: 'inherit', cursor: loading ? 'not-allowed' : 'pointer', marginTop: 4 }}
            >
